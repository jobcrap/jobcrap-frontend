                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <Input
                                    name="email"
                                    type="email"
                                    placeholder="agent@workstory.com"
                                    value={formData.email}
                                    onChange={handleChange}
                                    className={cn(
                                        "pl-12 h-14 rounded-2xl border-white/10 bg-white/5 focus:bg-white/10 text-lg transition-all duration-300",
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <Input
                                    ...
                                    onChange={handleChange}
                                    className={cn(
                                        "pl-12 pr-12 h-14 rounded-2xl border-white/10 bg-white/5 focus:bg-white/10 text-lg transition-all duration-300",
