            ...
            <div className="flex items-center justify-center p-6 sm:p-12 lg:p-20 relative bg-background/80 backdrop-blur-xl lg:border-l lg:border-white/5 max-lg:bg-transparent max-lg:text-white">
                ...
                <div className="w-full max-w-[440px] animate-fade-in-up">
                    <div className="mb-8">
                        ...
                        <h2 className="text-4xl font-black text-foreground max-lg:text-white mb-2 leading-tight">Create Account</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            <Label className="text-[11px] font-black uppercase tracking-widest ml-1 text-muted-foreground/80 max-lg:text-white/60">Username</Label>
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground max-lg:text-white/60 group-focus-within:text-primary transition-colors" />
                                <Input
                                    name="username"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        className={cn(
                                            "pl-12 pr-10 h-13 rounded-2xl border-white/10 bg-white/5 focus:bg-white/10 text-base transition-all duration-300 max-lg:text-white max-lg:placeholder:text-white/40",
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground max-lg:text-white/60 hover:text-primary transition-colors"
                                    >
                            ...
                            <div className="space-y-2">
                                <Label className="text-[11px] font-black uppercase tracking-widest ml-1 text-muted-foreground/80 max-lg:text-white/60">Confirm Password</Label>
                                <div className="relative group">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground max-lg:text-white/60 group-focus-within:text-primary transition-colors" />
                                    <Input
                    ...
                    <div className="relative my-6 flex items-center justify-center">
                        ...
                        <span className="relative bg-background max-lg:bg-transparent px-4 text-[10px] font-black text-muted-foreground max-lg:text-white/60 uppercase tracking-[0.15em]">
                            Or continue with
                        </span>
                    </div>
                    ...
                    <p className="text-center mt-6 text-sm font-medium text-muted-foreground max-lg:text-white/70">
